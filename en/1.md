...
Because [+] works on integers as well as on floating-point
...
produced in our previous function, we could have written its body like
this.
...
[tail] takes a list and returns its tail. In other
